...
function Input_Digit(digit) {
  ...
  // If we are waiting for the second operand, replace the display value
...
function Input_Decimal(dot) {
  // Prevent decimal input while waiting for second operand
  if (Calculator.Wait_Second_Operand === true) return;

  // Add decimal only if it does not already exist
...
function Handle_Operator(Next_Operator) {
  ...
  // Allow operator replacement if second operand not entered yet
  ...
  if (First_Operand === null) {
    ...
    // ✅ Correct line from the pictures
